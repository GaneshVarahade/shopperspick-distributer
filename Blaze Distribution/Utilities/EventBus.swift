...
public enum EventBusEventType : String {
    ...
    case FINISHSYNCINVOICE = "FINISHSYNCINVOICE"
    case FINISHSYNCPO = "FINISHSYNCPO"
    case FINISHSYNCINVENTORYTRANSFER = "FINISHSYNCINVENTORYTRANSFER"
    case FINISHSYNCPRODUCTS = "FINISHSYNCPRODUCTS"
}
