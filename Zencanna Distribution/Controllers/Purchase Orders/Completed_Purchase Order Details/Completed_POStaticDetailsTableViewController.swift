//
//  Completed_POStaticDetailsTableViewController.swift
//  shopperspick
//
...
class Completed_POStaticDetailsTableViewController: UITableViewController {
    ...
    @objc func getDataForPO(notification: Notification) {
        ...
        //if tempDict["metric_id"] != nil {
            metricIdLabel.text = "123456"//(tempDict["metric_id"] as! String)
